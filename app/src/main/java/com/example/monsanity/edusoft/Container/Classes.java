...
public class Classes {
    ...
    public Classes(String subject_id, String group, String room, int start_slot, int sum_slot, String instructor_id, String class_id, int class_size, int registered_number, String start_day, String end_day) {
