...
public class HorizontalPicker extends LinearLayout implements HorizontalPickerListener {
    ...
    public void init() {
        ...
        mDayOfWeekTextColor = mDayOfWeekTextColor == -1 ? getColor(R.color.color_dayOfWeek) : mDayOfWeekTextColor;
        mUnselectedDayTextColor = mUnselectedDayTextColor == -1 ? getColor(R.color.color_dayOfMonth) : mUnselectedDayTextColor;
        rvDays.init(
                getContext(),
                finalDays,
                finalOffset,
        ...
        vHover.setLayoutParams(new LayoutParams(Math.round(rvDays.itemWidth), Math.round(rvDays.itemWidth)));
    }
...
//        rvDays.smoothScrollToPosition(rvDays.getLastPosition()+7);
    ...
    @Override
    public void onMonthChanged(Day item) {
        tvMonth.setText(item.getMonth(mMonthPattern));
    }
